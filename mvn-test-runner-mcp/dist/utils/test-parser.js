...
export class TestParser {
     ...
     */
    async parseTestResults(rawOutput) {
     ...
     */
    extractFailuresFromOutput(output) {
        const failures = [];
