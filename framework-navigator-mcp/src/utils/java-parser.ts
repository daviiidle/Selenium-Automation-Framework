...
export class JavaParser {
   ...
   */
  private static extractClassAnnotations(lines: string[]): string[] {
   ...
   */
  private static extractMethods(lines: string[]): MethodInfo[] {
   ...
   */
  private static extractFields(lines: string[]): FieldInfo[] {
   ...
   */
  static extractSelectors(content: string): Array<{name: string; selector: string; type: string; lineNumber: number}> {
    const selectors: Array<{name: string; selector: string; type: string; lineNumber: number}> = [];
    const lines = content.split('\n');
