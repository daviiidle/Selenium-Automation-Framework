...
// Singleton index
let frameworkIndex = null;
async function ensureIndexed(frameworkRoot) {
...
export function registerRelationshipTools(frameworkRoot) {
    return [
        {
        ...
        },
        {
            ...
            handler: async (args) => {
                ...
                // Build hierarchy
                const hierarchy = [classInfo.classInfo.className];
        ...
        },
        {
            ...
            handler: async (args) => {
                ...
                const subclasses = allClasses.filter(c => c.classInfo.extendsClass === args.baseClass);
                return {
        ...
        },
        {
            ...
            handler: async (args) => {
                const index = await ensureIndexed(frameworkRoot);
                const allClasses = index.getAllClasses();
                const packageClasses = allClasses.filter(c => c.classInfo.packageName === args.packageName ||
