...
export class CodeModifier {
   ...
   */
  async updatePageObjectSelector(
    ...
    const filePath = path.join(
      this.frameworkRoot,
      'src/main/java/com/demowebshop/automation/pages',
      `${pageClassName}.java`
    );
   ...
   */
  async clearOldBackups(keepLast: number = 10): Promise<number> {
    try {
