...
export function registerLiveTestingTools(frameworkRoot) {
            ...
            handler: async (args) => {
                ...
                try {
                    ...
                    for (const [name, selectorDef] of Object.entries(selectors)) {
                        if (typeof selectorDef !== 'object' || !selectorDef)
                            continue;
                        const def = selectorDef;
                        const selector = {
                            type: def.type || 'css',
...
//# sourceMappingURL=live-testing.js.map