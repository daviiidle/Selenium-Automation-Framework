...
export class FrameworkReader {
     ...
     */
    async readSelectorFile(selectorFile) {
     ...
     */
    async readTestNGConfig(configFile = 'testng-powerhouse.xml') {
     ...
     */
    async readTestClass(testClassName) {
     ...
     */
    async readPageObject(pageClassName) {
     ...
     */
    extractTestMethods(testClassContent) {
        const tests = [];
     ...
     */
    extractSelectorsFromPageObject(pageObjectContent) {
        const selectors = [];
...
//# sourceMappingURL=framework-reader.js.map